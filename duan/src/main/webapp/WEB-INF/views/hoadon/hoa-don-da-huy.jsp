...
<div>
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="/hoa-don/hien-thi-da-huy"
               role="tab"
               aria-controls="description" aria-selected="true">Hóa đơn đã hủy</a>
        </li>
    </ul>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="loc" style="color:black;">
                        <form:form action="/hoa-don/loc-da-huy" method="post" modelAttribute="hoaDon">
                    ...
                    <br>
<%--                    <div class="search">--%>
<%--                        <form action="/hoa-don/search-da-huy" method="post">--%>
